...
parser.add_argument('--loadckpt', default='./checkpoint/ghustereo4_efficientnet_backbone_nc_kitti.ckpt', help='load the weights from a specific checkpoint')
parser.add_argument('--cv_scale', type=int, default=4, help='cost volume scale factor', choices=[8, 4])

parser.add_argument('--cv', type=str, default='norm_correlation', choices=[
          'norm_correlation',
          'gwc',
